...
bgm_path = ARGV.length > 0 ? ARGV[0] : first_existing(["ZMD/simplebgm.ZMD", "../ZMD/simplebgm.ZMD"])
se_path = ARGV.length > 1 ? ARGV[1] : first_existing(["ZMD/laser.ZMD", "../ZMD/laser.ZMD"])
pcm_path = ARGV.length > 2 ? ARGV[2] : first_existing(["ZMD/snare.pcm", "../ZMD/snare.pcm"])
